...
qr_scanner():image_trans(node_handle){
    image_sub = image_trans.subscribe("camera_module/video_stream", 2, &qr_scanner::qr_scannerCallback,this);
    image_pub = image_trans.advertise("qr_scanner/video_stream", 2);
}
